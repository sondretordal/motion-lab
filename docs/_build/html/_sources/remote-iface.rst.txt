...
The remote has to switch to use a static IP adress which is set to ``192.168.90.60`` using subnet ``255.255.255.0``. Also ensure that nothing else is using the port ``50060`` since it will be used for the UDP communication with Motion Lab.
