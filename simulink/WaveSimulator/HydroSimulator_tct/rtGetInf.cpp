...
real_T CHydroSimulator::rtGetInf (void)
  {
...
real32_T CHydroSimulator::rtGetInfF (void)
  {
    IEEESingle infF;
...
real_T CHydroSimulator::rtGetMinusInf (void)
  {
    size_t bitsPerReal = sizeof(real_T) * (NumBitsPerChar);
    real_T minf = 0.0;
    if (bitsPerReal == 32U) {
...
real32_T CHydroSimulator::rtGetMinusInfF (void)
  {
    IEEESingle minfF;
