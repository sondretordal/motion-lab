...
real_T CWaveSimulatorNew::rtGetInf (void)
  {
...
real32_T CWaveSimulatorNew::rtGetInfF (void)
  {
    IEEESingle infF;
...
real_T CWaveSimulatorNew::rtGetMinusInf (void)
  {
    size_t bitsPerReal = sizeof(real_T) * (NumBitsPerChar);
    real_T minf = 0.0;
    if (bitsPerReal == 32U) {
...
real32_T CWaveSimulatorNew::rtGetMinusInfF (void)
  {
    IEEESingle minfF;
