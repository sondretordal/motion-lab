...
real_T CWaveSimulator0::rtGetInf (void)
  {
...
real32_T CWaveSimulator0::rtGetInfF (void)
  {
    IEEESingle infF;
...
real_T CWaveSimulator0::rtGetMinusInf (void)
  {
    size_t bitsPerReal = sizeof(real_T) * (NumBitsPerChar);
    real_T minf = 0.0;
    if (bitsPerReal == 32U) {
...
real32_T CWaveSimulator0::rtGetMinusInfF (void)
  {
    IEEESingle minfF;
