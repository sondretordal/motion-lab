...
real_T CToolPlaneDistance::rtGetInf (void)
  {
...
real32_T CToolPlaneDistance::rtGetInfF (void)
  {
    IEEESingle infF;
...
real_T CToolPlaneDistance::rtGetMinusInf (void)
  {
    size_t bitsPerReal = sizeof(real_T) * (NumBitsPerChar);
    real_T minf = 0.0;
    if (bitsPerReal == 32U) {
...
real32_T CToolPlaneDistance::rtGetMinusInfF (void)
  {
    IEEESingle minfF;
